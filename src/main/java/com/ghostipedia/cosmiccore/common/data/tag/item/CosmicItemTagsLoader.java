...
public class CosmicItemTagsLoader {
    ...
    public static ItemEntry<?>[] WANDERERS_ARMORS = {CosmicItems.WANDERERS_HELMET, CosmicItems.WANDERERS_CHESTPLATE,
    ...
    public static void init(RegistrateTagsProvider<Item> provider) {
        ...
        create(provider, CosmicItemTags.WANDERERS_ARMOR, WANDERERS_ARMORS);
